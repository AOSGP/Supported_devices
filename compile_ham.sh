...
make clobber
source build/envsetup.sh && breakfast ham && time make -j32 bacon
cd /var/lib/jenkins/aosgp/out/target/product/ham/
rename 's/lineage-aosgp/aosgp/' lineage-aosgp-X-2.1.1*.zip
mv aosgp-X-2.1.1-*.zip /var/www/html/downloads/AOSGP/ZUK/Z1-ham/